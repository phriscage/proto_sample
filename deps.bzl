...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:CiQ/hJK0Lsc/2Gm9uMSIe7cFE+h0sbTwHuTGQkIZpio=",
        version = "v3.2.1-0.20200107013213-dc14462fd587+incompatible",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_infobloxopen_atlas_app_toolkit",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/infobloxopen/atlas-app-toolkit",
        sum = "h1:cAaSeFd94/LonbiukVipbnKGmQehlJ2JbScBf1ZR87k=",
        version = "v1.4.0",
    )
    go_repository(
        name = "com_github_infobloxopen_protoc_gen_gorm",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/infobloxopen/protoc-gen-gorm",
        sum = "h1:duf3zI/miY1uSvm6LQA5stAwucZWnfcdR9L34PbIuOw=",
        version = "v1.1.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:GeKe/1r/0LW8inPmRZi6zVInaZcFXiMzTnPyxITwQ8A=",
        version = "v1.3.1-0.20200116171513-9eb3fc897d6f",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_speps_go_hashids_v2",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/speps/go-hashids/v2",
        sum = "h1:ViWOEqWES/pdOSq+C1SLVa8/Tnsd52XC34RY7lt7m4g=",
        version = "v2.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BAoHne8qdVajNF3kD1n8TES+7XpyOUr3u8Wvq/TSoNw=",
        version = "v0.0.0-20210715165331-ce7bdf50abb1",
    )
    go_repository(
